...
Implementation of a user settings feature for exalidraw-max Tauri desktop application. Users can access settings via `Cmd+,` / `Ctrl+,` shortcut or menu, configure preferences in a modal dialog, and persist changes using Tauri store plugin.
